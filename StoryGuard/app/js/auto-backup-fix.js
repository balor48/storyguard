// COMPLETELY REWRITTEN Auto-backup fix script
// This version OVERRIDES all other auto-backup functionality to avoid conflicts
(function() {
    console.log('AUTO-BACKUP FIX SCRIPT LOADED - COMPLETE OVERRIDE VERSION');
    ...
    function startMasterAutoBackupTimer() {
        ...
        // CRITICAL BUG FIX: Don't force a minimum of 1 minute!
        // This was forcing all intervals to 1 minute when settings.interval was coming in as 0 or NaN
        const intervalMinutes = settings.interval ? parseInt(settings.interval, 10) : 30;
        
        // Validate the parsed value - using 5 minutes as absolute minimum for safety
        const validIntervalMinutes = isNaN(intervalMinutes) || intervalMinutes < 5 ? 30 : intervalMinutes;
    ...
    function initialize() {
        console.log('Initializing MASTER auto-backup system');
        ...
        // MODIFIED: Make the periodic check less frequent to avoid interference
        // and add more debugging info
        ...
        }, 300000); // Changed from every minute to every 5 minutes
    }
    ...
    console.log('MASTER auto-backup fix loaded successfully');
})();
